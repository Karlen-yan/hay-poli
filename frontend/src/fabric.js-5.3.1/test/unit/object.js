(function() {
  ...
  QUnit.test('set', function(assert) {
    const cObj = new fabric.Object({left: 11, top: 22, width: 50, height: 60, opacity: 0.7});
  ...
  QUnit.test('toJSON', function(assert) {
    const emptyObjectJSON = '{"type":"object","version":"' + fabric.version + '","originX":"left","originY":"top","left":0,"top":0,"width":0,"height":0,"fill":"rgb(0,0,0)",' +
    ...
    const augmentedJSON = '{"type":"object","version":"' + fabric.version + '","originX":"left","originY":"top","left":0,"top":0,"width":122,"height":0,"fill":"rgb(0,0,0)",' +
  ...
  QUnit.test('toObject without default values', function(assert) {
    const emptyObjectRepr = {version: fabric.version, type: 'object', top: 0, left: 0};
  ...
  QUnit.test('drawBorders', function(assert) {
    const cObj = new fabric.Object(), canvas = fabric.document.createElement('canvas');

    const dummyContext = canvas.getContext('2d');
  ...
  QUnit.test('drawControls', function(assert) {
    const cObj = new fabric.Object(), _canvas = fabric.document.createElement('canvas');
    cObj.canvas = canvas;
    const dummyContext = _canvas.getContext('2d');
    assert.ok(typeof cObj.drawControls === 'function');
    assert.equal(cObj.drawControls(dummyContext), cObj, 'chainable');
  });

  QUnit.test('clone', function(assert) {
    const cObj = new fabric.Object({left: 123, top: 456, opacity: 0.66});
  ...
  QUnit.test('cloneAsImage', function(assert) {
    ...
    const cObj = new fabric.Rect({width: 100, height: 100, fill: 'red', strokeWidth: 0});
  ...
  QUnit.test('toCanvasElement activeSelection', function(assert) {
    ...
    const cObj2 = new fabric.Rect({
      width: 100, height: 100, fill: 'red', strokeWidth: 0,
    });

    canvas.add(cObj, cObj2);

    const activeSel = new fabric.ActiveSelection([cObj, cObj2], {canvas: canvas});
  ...
  QUnit.test('toggle', function(assert) {
    const object = new fabric.Object({left: 100, top: 124, width: 210, height: 66});
  ...
  QUnit.test('_setLineDash', function(assert) {
    const object = new fabric.Rect({left: 100, top: 124, width: 210, height: 66, stroke: 'black', strokeWidth: 2});
  ...
  QUnit.test('fxStraighten', function(assert) {
    ...
    const onComplete = function() {onCompleteFired = true;};

    let onChangeFired = false;
    const onChange = function() {onChangeFired = true;};
  ...
  QUnit.test('canvas reference', function(assert) {
    const object = new fabric.Object();
    const object2 = new fabric.Object();
  ...
  QUnit.test('getTotalObjectScaling with zoom', function(assert) {
    const object = new fabric.Object({scaleX: 3, scaleY: 2});
    canvas.setZoom(3);
    canvas.add(object);
  ...
  QUnit.test('getObjectScaling in group with object rotated', function(assert) {
    const object = new fabric.Object({scaleX: 3, scaleY: 2, angle: 45});
    const group = new fabric.Group();
    group.scaleX = 2;
    group.scaleY = 3;
    object.group = group;
  ...
  QUnit.test('_createCacheCanvas sets object as dirty', function(assert) {
    const object = new fabric.Object({scaleX: 3, scaleY: 2, width: 1, height: 2});
  ...
  QUnit.test('_getCacheCanvasDimensions returns dimensions and zoom for cache canvas', function(assert) {
    const object = new fabric.Object({width: 10, height: 10, strokeWidth: 0});
    let dims = object._getCacheCanvasDimensions();
  ...
  QUnit.test('_getCacheCanvasDimensions and strokeUniform', function(assert) {
    const object = new fabric.Object({width: 10, height: 10, strokeWidth: 2});
  ...
  QUnit.test('_limitCacheSize limit min to 256', function(assert) {
    ...
    fabric.maxCacheSideLimit = 4096;
    fabric.minCacheSideLimit = 256;
    const object = new fabric.Object({width: 200, height: 200, strokeWidth: 0});
  ...
  QUnit.test('_limitCacheSize does not limit if not necessary', function(assert) {
    ...
    fabric.maxCacheSideLimit = 4096;
    fabric.minCacheSideLimit = 256;
    const object = new fabric.Object({width: 400, height: 400, strokeWidth: 0});
    const dims = object._getCacheCanvasDimensions();
    const zoomX = dims.zoomX;
    const zoomY = dims.zoomY;
    const limitedDims = object._limitCacheSize(dims);
  ...
  QUnit.test('_limitCacheSize does cap up if necessary', function(assert) {
    ...
    fabric.maxCacheSideLimit = 4096;
    fabric.minCacheSideLimit = 256;
    const object = new fabric.Object({width: 2046, height: 2046, strokeWidth: 0});
    const dims = object._getCacheCanvasDimensions();
    const width = dims.width;
    const height = dims.height;
    const zoomX = dims.zoomX;
  ...
  QUnit.test('_limitCacheSize does cap up if necessary to maxCacheSideLimit', function(assert) {
    ...
    fabric.maxCacheSideLimit = 4096;
    fabric.minCacheSideLimit = 256;
    const object = new fabric.Object({width: 8192, height: 8192, strokeWidth: 0});
    const dims = object._getCacheCanvasDimensions();
    const zoomX = dims.zoomX;
    const zoomY = dims.zoomY;
    const limitedDims = object._limitCacheSize(dims);
  ...
  QUnit.test('_limitCacheSize does cap up if necessary to maxCacheSideLimit, different AR', function(assert) {
    ...
    fabric.maxCacheSideLimit = 4096;
    fabric.minCacheSideLimit = 256;
    const object = new fabric.Object({width: 16384, height: 8192, strokeWidth: 0});
    const dims = object._getCacheCanvasDimensions();
    const width = dims.width;
    const height = dims.height;
    const zoomX = dims.zoomX;
  ...
  QUnit.test('_setShadow', function(assert) {
    const canvas = new fabric.StaticCanvas(null, {enableRetinaScaling: false, width: 600, height: 600});
    const context = canvas.contextContainer;
    const object = new fabric.Object({scaleX: 1, scaleY: 1});
    const group = new fabric.Group();
    group.scaleX = 2;
    group.scaleY = 2;
  ...
  QUnit.test('willDrawShadow', function(assert) {
    const object = new fabric.Object({shadow: {offsetX: 0, offsetY: 0}});
  ...
  QUnit.test('_set  change a property', function(assert) {
    const object = new fabric.Object({fill: 'blue'});
  ...
  QUnit.test('isNotVisible', function(assert) {
    let object = new fabric.Object({fill: 'blue', width: 100, height: 100});
  ...
  QUnit.test('hasStroke', function(assert) {
    const object = new fabric.Object({fill: 'blue', width: 100, height: 100, strokeWidth: 3, stroke: 'black'});
  ...
  QUnit.test('hasFill', function(assert) {
    const object = new fabric.Object({fill: 'blue', width: 100, height: 100});
