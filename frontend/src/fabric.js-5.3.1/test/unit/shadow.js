(function() {
  ...
  QUnit.test('initializing with object', function(assert) {
    ...
    const shadow = new fabric.Shadow(REFERENCE_SHADOW_OBJECT);
  ...
  QUnit.test('initializing with string', function(assert) {
    ...
    const shadow1 = new fabric.Shadow('rgba(0,0,255,0.5) 10px 20px 5px');
    ...
    const shadow2 = new fabric.Shadow('rgb(0,0,255) 10px 20px ');
    ...
    const shadow3 = new fabric.Shadow('#00FF00 30 10 ');
    ...
    const shadow4 = new fabric.Shadow(' #FF0000 10px');
    ...
    const shadow5 = new fabric.Shadow('#000000');
    ...
    const shadow6 = new fabric.Shadow('10px 20px 5px rgba(0,0,255,0.5)');
    ...
    const shadow7 = new fabric.Shadow('10 20 5px #00FF00');
    ...
    const shadow8 = new fabric.Shadow('10px 20px rgb(0,0,255)');
    ...
    const shadow9 = new fabric.Shadow(' 10px #FF0000 ');
    ...
    const shadow10 = new fabric.Shadow('  #FF0000 ');
    ...
    const shadow11 = new fabric.Shadow('');
    ...
    const shadow12 = new fabric.Shadow('#FF0000 0.1px 0.1px 0.28px');
    ...
    const shadow13 = new fabric.Shadow('rgba(0,0,255,0.5) -0.1px -0.1px 0.28px');
    ...
    const shadow14 = new fabric.Shadow('rgba(0,0,255,0.5) -0.1 -0.1 0.77');
    ...
    const shadow15 = new fabric.Shadow('rgba(0,0,255,0.5) 0.1 0.1 1');
  ...
  QUnit.test('clone with affectStroke', function(assert) {
    const shadow = new fabric.Shadow({affectStroke: true, blur: 5});
    assert.ok(typeof shadow.toObject === 'function');
    const object = shadow.toObject(),
  ...
  QUnit.test('toSVG', function(assert) {
    ...
    const shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: -10, blur: 2});
    const object = new fabric.Object({fill: '#FF0000'});
  ...
  QUnit.test('toSVG with flipped object', function(assert) {
    ...
    const shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: -10, blur: 2});
    const object = new fabric.Object({fill: '#FF0000', flipX: true, flipY: true});
  ...
  QUnit.test('toSVG with rotated object', function(assert) {
    ...
    const shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: 10, blur: 2});
    const object = new fabric.Object({fill: '#FF0000', angle: 45});
  ...
  QUnit.test('toSVG with rotated flipped object', function(assert) {
    ...
    const shadow = new fabric.Shadow({color: '#FF0000', offsetX: 10, offsetY: 10, blur: 2});
    const object = new fabric.Object({fill: '#FF0000', angle: 45, flipX: true});
