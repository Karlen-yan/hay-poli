(function() {
  ...
  function getPathElement(path) {
    ...
    const el = fabric.document.createElementNS(namespace, 'path');
  ...
  QUnit.test('initialize', function(assert) {
    const done = assert.async();
    const path = new fabric.Path('M 100 100 L 200 100 L 170 200 z', {top: 0, strokeWidth: 0});
  ...
  QUnit.test('initialize with strokeWidth', function(assert) {
    const done = assert.async();
    const path = new fabric.Path('M 100 100 L 200 100 L 170 200 z', {strokeWidth: 50});
  ...
  QUnit.test('set path after initialization', function(assert) {
    const done = assert.async();
    const path = new fabric.Path('M 100 100 L 200 100 L 170 200 z', REFERENCE_PATH_OBJECT);
    ...
    const opts = fabric.util.object.clone(REFERENCE_PATH_OBJECT);
    delete opts.path;
    path.set(opts);
  ...
  QUnit.test('toDatalessObject with sourcePath', function(assert) {
    ...
    makePathObject(function(path) {
      ...
      path.sourcePath = src;
      const clonedRef = fabric.util.object.clone(REFERENCE_PATH_OBJECT);
  ...
  QUnit.test('fromElement', function(assert) {
    ...
    const namespace = 'http://www.w3.org/2000/svg';
    const elPath = fabric.document.createElementNS(namespace, 'path');
  ...
  QUnit.test('multiple sequences in path commands', function(assert) {
    const done = assert.async();
    let el = getPathElement('M100 100 l 200 200 300 300 400 -50 z');
  ...
  QUnit.test('multiple M/m coordinates converted all L', function(assert) {
    const done = assert.async();
    const el = getPathElement('M100 100 200 200 150 50 m 300 300 400 -50 50 100');
    fabric.Path.fromElement(el, function(obj) {
      assert.deepEqual(obj.path[0], ['M', 100, 100]);
  ...
  QUnit.test('multiple M/m commands converted all as M commands', function(assert) {
    const done = assert.async();
    const el = getPathElement('M100 100 M 200 200 M150 50 m 300 300 m 400 -50 m 50 100');
    fabric.Path.fromElement(el, function(obj) {
      assert.deepEqual(obj.path[0], ['M', 100, 100]);
  ...
  QUnit.test('compressed path commands', function(assert) {
    const done = assert.async();
    const el = getPathElement('M56.224 84.12C-.047.132-.138.221-.322.215.046-.131.137-.221.322-.215z');
    fabric.Path.fromElement(el, function(obj) {
  ...
  QUnit.test('compressed path commands with e^x', function(assert) {
    const done = assert.async();
    const el = getPathElement('M56.224e2 84.12E-2C-.047.132-.138.221-.322.215.046-.131.137-.221.322-.215m-.050 -20.100z');
    fabric.Path.fromElement(el, function(obj) {
