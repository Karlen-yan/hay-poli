(function() {
  ...
  function clipping0(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 100, strokeWidth: 0, top: -10, left: -10});
    const obj = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 200, height: 200, fill: 'rgba(0,255,0,0.5)'});
  ...
  function clipping01(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 50, strokeWidth: 40, top: -50, left: -50, fill: 'transparent'});
    const obj = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 200, height: 200, fill: 'rgba(0,255,0,0.5)'});
    obj.clipPath = clipPath;
    canvas.add(obj);
    toSVGCanvas(canvas, callback);
  ...
  function clipping1(canvas, callback) {
    const zoom = 20;
    canvas.setZoom(zoom);
    const clipPath = new fabric.Circle({radius: 5, strokeWidth: 0, top: -2, left: -2});
    const obj = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 10, height: 10, fill: 'rgba(255,0,0,0.5)'});
    obj.clipPath = clipPath;
    canvas.add(obj);
    toSVGCanvas(canvas, callback);
  }
  ...
  function clipping3(canvas, callback) {
    ...
    const small2 = new fabric.Rect({width: 30, height: 30, top: -50, left: -50});
    const group = new fabric.Group([
  ...
  function clipping4(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 20, strokeWidth: 0, top: -10, left: -10, scaleX: 2, skewY: 45});
    const obj = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 200, height: 200, fill: 'rgba(0,255,0,0.5)'});
  ...
  function clipping5(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 20, strokeWidth: 0, top: -10, left: -10, scaleX: 2, skewY: 45});
    const clipPath1 = new fabric.Circle({radius: 15, rotate: 45, strokeWidth: 0, top: -100, left: -50, scaleX: 2, skewY: 45});
    const clipPath2 = new fabric.Circle({radius: 10, strokeWidth: 0, top: -20, left: -20, scaleY: 2, skewX: 45});
  ...
  function clipping7(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 30, strokeWidth: 0, top: -30, left: -30, skewY: 45});
    const obj1 = new fabric.Rect({top: 0, left: 100, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(0,255,0,0.8)'});
    const obj2 = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(255,255,0,0.8)'});
    const obj3 = new fabric.Rect({top: 100, left: 0, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(0,255,255,0.8)'});
    const obj4 = new fabric.Rect({top: 100, left: 100, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(255,0,0,0.8)'});
  ...
  function clipping8(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 60, strokeWidth: 0, top: 40, left: 40, absolutePositioned: true});
    const obj1 = new fabric.Rect({top: 0, left: 100, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(0,255,0,0.8)'});
    const obj2 = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(255,255,0,0.8)'});
    const obj3 = new fabric.Rect({top: 100, left: 0, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(0,255,255,0.8)'});
    const obj4 = new fabric.Rect({top: 100, left: 100, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(255,0,0,0.8)'});
  ...
  function clipping9(canvas, callback) {
    const clipPath = new fabric.Circle({radius: 60, strokeWidth: 0, top: 10, left: 10});
    const obj1 = new fabric.Rect({top: 0, left: 100, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(0,255,0,0.8)'});
    const obj2 = new fabric.Rect({top: 0, left: 0, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(255,255,0,0.8)'});
    const obj3 = new fabric.Rect({top: 100, left: 0, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(0,255,255,0.8)'});
    const obj4 = new fabric.Rect({top: 100, left: 100, strokeWidth: 0, width: 100, height: 100, fill: 'rgba(255,0,0,0.8)'});
  ...
  function clipping12(canvas, callback) {
    const jsonData = '{"version":"2.4.6","objects":[{"type":"ellipse","version":"2.4.6","left":2.5,"top":-56.5,"width":220,"height":300,"fill":{"type":"radial","coords":{"x1":110.00000000000001,"y1":110.00000000000001,"x2":110.00000000000001,"y2":110.00000000000001,"r1":0,"r2":110.00000000000001},"colorStops":[{"offset":1,"color":"rgb(0,0,255)","opacity":1},{"offset":0.6,"color":"rgb(0,153,153)","opacity":0.5},{"offset":0.3,"color":"rgb(0,0,255)","opacity":1},{"offset":0,"color":"rgb(255,0,0)","opacity":0.8}],"offsetX":0,"offsetY":0,"gradientTransform":[1,0,0,1.3636363636363635,0,0]},"scaleX":0.69,"scaleY":1.07,"skewY":-32.03,"rx":110,"ry":150}]}';
    canvas.loadFromJSON(jsonData, function() {
      toSVGCanvas(canvas, callback);
    });
  }
